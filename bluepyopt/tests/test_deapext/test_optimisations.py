...
def test_DEAPOptimisation_constructor():
    ...
    optimisation = bluepyopt.deapext.IBEADEAPoptimisations.IBEADEAPOptimisation(
...
def test_selectorname():
    ...
    # Test default value
    ibea_optimisation = bluepyopt.deapext.IBEADEAPoptimisations.IBEADEAPOptimisation(
        examples.simplecell.cell_evaluator)
    nt.assert_equal(ibea_optimisation.selector_name, 'IBEA')

    # Test NSGA2 selector
    nsga2_optimisation = bluepyopt.deapext.IBEADEAPoptimisations.IBEADEAPOptimisation(
